        ...
        >
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(244,182,66,0.16) 0%, rgba(244,182,66,0.08) 38%, rgba(244,182,66,0) 72%)",
            ...
            >
                <div
                    style={{
                        ...
                        inset: 0,
                        borderRadius: "50%",
                        background: "conic-gradient(from 160deg, rgba(0,0,0,0) 0deg, rgba(0,0,0,0) 220deg, rgba(216,155,43,0.88) 262deg, rgba(244,182,66,0.92) 290deg, rgba(255,222,189,0.3) 306deg, rgba(0,0,0,0) 330deg, rgba(0,0,0,0) 360deg)",
            ...
            >
                <div
                    style={{
                        ...
                        inset: 0,
                        borderRadius: "50%",
                        background: "conic-gradient(from 24deg, rgba(0,0,0,0) 0deg, rgba(244,182,66,0.16) 78deg, rgba(216,155,43,0.6) 104deg, rgba(0,0,0,0) 144deg, rgba(0,0,0,0) 360deg)",
            ...
            {emberSpecs.map((ember, index) => (
                <div
                    ...
                    style={{
                        ...
                        borderRadius: "50%",
                        background: "radial-gradient(circle, rgba(255,243,224,1) 0%, rgba(244,182,66,0.98) 35%, rgba(216,155,43,0.35) 66%, rgba(216,155,43,0) 100%)",
                        boxShadow: "0 0 12px rgba(244,182,66,0.34)",
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(255,220,176,0.16) 0%, rgba(244,182,66,0.1) 36%, rgba(216,155,43,0.06) 52%, rgba(0,0,0,0) 72%)",
                    filter: "blur(8px)",
                }}
            />
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle at 50% 42%, #FFF4E6 0%, #FFD0A7 20%, var(--tekori-amber) 42%, var(--tekori-gold) 68%, #7B230C 100%)",
                ...
                >
                    <div
                        style={{
                            ...
                            background: "linear-gradient(180deg, #FFF4E6 0%, #FFD0A7 28%, var(--tekori-amber) 56%, var(--tekori-gold) 78%, #8F2A0E 100%)",
                        }}
                    />
                    <div
                        style={{
                            ...
                            background: "linear-gradient(180deg, rgba(255,250,244,0.96) 0%, rgba(255,226,191,0.98) 46%, rgba(244,182,66,0.72) 100%)",
                            filter: "blur(0.4px)",
                        }}
                    />
                </div>
