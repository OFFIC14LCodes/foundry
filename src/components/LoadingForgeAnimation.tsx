        ...
        >
            <style>{`
                ...
                @keyframes foundryCorePulse {
                    0%, 100% {
                        ...
                        box-shadow:
                            0 0 0 rgba(216,155,43,0),
                            0 0 18px rgba(216,155,43,0.25),
                            0 0 34px rgba(244,199,106,0.14);
                    }
                    50% {
                        transform: translate(-50%, -50%) scale(1.04);
                        box-shadow:
                            0 0 0 rgba(216,155,43,0),
                            0 0 26px rgba(216,155,43,0.4),
                            0 0 48px rgba(244,199,106,0.24);
                    }
                }
            ...
            <div
                style={{
                    ...
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(216,155,43,0.08) 0%, rgba(216,155,43,0.03) 42%, rgba(0,0,0,0) 68%)",
                    filter: "blur(12px)",
                }}
            />
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(244,199,106,0.16) 0%, rgba(244,199,106,0.08) 38%, rgba(244,199,106,0) 72%)",
            ...
            <div
                style={{
                    ...
                    boxShadow: "inset 0 0 20px rgba(7,26,47,0.03), 0 0 24px rgba(0,0,0,0.18)",
                }}
            />
            ...
            >
                <div
                    style={{
                        ...
                        inset: 0,
                        borderRadius: "50%",
                        background: "conic-gradient(from 160deg, rgba(0,0,0,0) 0deg, rgba(0,0,0,0) 220deg, rgba(216,155,43,0.88) 262deg, rgba(244,199,106,0.92) 290deg, rgba(255,222,189,0.3) 306deg, rgba(0,0,0,0) 330deg, rgba(0,0,0,0) 360deg)",
            ...
            >
                <div
                    style={{
                        ...
                        inset: 0,
                        borderRadius: "50%",
                        background: "conic-gradient(from 24deg, rgba(0,0,0,0) 0deg, rgba(244,199,106,0.16) 78deg, rgba(216,155,43,0.6) 104deg, rgba(0,0,0,0) 144deg, rgba(0,0,0,0) 360deg)",
            ...
            {emberSpecs.map((ember, index) => (
                <div
                    ...
                    style={{
                        ...
                        borderRadius: "50%",
                        background: "radial-gradient(circle, rgba(255,243,224,1) 0%, rgba(244,199,106,0.98) 35%, rgba(216,155,43,0.35) 66%, rgba(216,155,43,0) 100%)",
                        boxShadow: "0 0 12px rgba(244,199,106,0.34)",
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(255,220,176,0.16) 0%, rgba(244,199,106,0.1) 36%, rgba(216,155,43,0.06) 52%, rgba(0,0,0,0) 72%)",
                    filter: "blur(8px)",
                }}
            />
            ...
            <div
                style={{
                    ...
                    transform: "translate(-50%, -50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle at 50% 42%, #FFF4E6 0%, #FFD0A7 20%, var(--tekori-gold) 42%, var(--tekori-gold) 68%, #7B230C 100%)",
                ...
                >
                    <div
                        style={{
                            ...
                            background: "linear-gradient(180deg, #FFF4E6 0%, #FFD0A7 28%, var(--tekori-gold) 56%, var(--tekori-gold) 78%, #8F2A0E 100%)",
                        }}
                    />
                    <div
                        style={{
                            ...
                            background: "linear-gradient(180deg, rgba(255,250,244,0.96) 0%, rgba(255,226,191,0.98) 46%, rgba(244,199,106,0.72) 100%)",
                            filter: "blur(0.4px)",
                        }}
                    />
                </div>
