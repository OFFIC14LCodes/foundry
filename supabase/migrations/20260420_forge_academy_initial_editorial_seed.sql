...
set
    title = case slug
        ...
        when 'analysis-paralysis-is-not-caution' then 'Overthinking Wears a Respectable Face'
        when 'fear-of-selling-is-fear-of-judgment' then 'Selling Feels Personal Because It Is'
        when 'imposter-syndrome-loves-vague-standards' then 'Imposter Syndrome Thrives on Blurry Standards'
        when 'hesitation-is-usually-self-protection' then 'Hesitation Usually Means You''re Protecting Something'
    ...
    short_description = case slug
        ...
        when 'analysis-paralysis-is-not-caution' then 'Delay often sounds intelligent long before it admits it is fear.'
        when 'fear-of-selling-is-fear-of-judgment' then 'What founders call “sales discomfort” is often the fear of being seen and rejected clearly.'
        when 'imposter-syndrome-loves-vague-standards' then 'The less clearly you define what a capable founder looks like, the easier it is to keep disqualifying yourself.'
        when 'hesitation-is-usually-self-protection' then 'A surprising amount of hesitation is really a quiet attempt to stay emotionally safe.'
        when 'decision-avoidance-feels-smart-until-it-costs-you' then 'Not choosing feels safer than choosing right up until the drift bill arrives.'
        when 'confidence-is-built-from-reps-not-mood' then 'Confidence usually shows up after contact with the work, not before it.'
        when 'how-to-talk-to-users-startup-school' then 'A practical YC companion on getting signal from conversations instead of compliments.'
        when 'how-to-get-your-first-customers-startup-school' then 'A reality check on what early traction actually asks of a founder.'
        ...
        when 'business-model-pressure-test' then 'A simple framework for finding the soft spots in the business before the market does.'
        when 'customer-discovery-interview-guide' then 'A practical interview structure built to surface truth instead of politeness.'
        when 'simple-pricing-ladder' then 'A cleaner way to think about entry price, expansion, and what your pricing is training people to expect.'
    ...
    description = case slug
        ...
        when 'analysis-paralysis-is-not-caution' then 'Overthinking becomes dangerous when it borrows the language of intelligence. This entry is about recognizing when more analysis is genuinely useful and when it is simply a respectable disguise for emotional self-protection.'
        when 'fear-of-selling-is-fear-of-judgment' then 'Selling feels loaded because it forces a founder into a clean moment of exposure: here is what I believe, here is what I charge, here is the ask. This topic helps untangle the sales problem from the identity problem hiding underneath it.'
        when 'imposter-syndrome-loves-vague-standards' then 'Imposter syndrome gets stronger when the founder keeps moving the bar for what would count as “legitimate.” This entry is about exposing the hidden standards that keep capable founders feeling chronically disqualified.'
        when 'hesitation-is-usually-self-protection' then 'A lot of hesitation is not uncertainty about what to do. It is a reluctance to pay the emotional cost of doing it. This topic helps founders see that more clearly without softening the reality of it.'
        when 'decision-avoidance-feels-smart-until-it-costs-you' then 'Some founders are better at preserving optionality than choosing a path. This entry is about the hidden operating cost of non-decisions, and why drift can be more expensive than picking imperfectly.'
        when 'confidence-is-built-from-reps-not-mood' then 'Founders often wait for a feeling that only shows up after repeated contact with the work. This topic strips confidence of mystique and puts it back where it belongs: reps, exposure, and earned self-trust.'
        when 'how-to-talk-to-users-startup-school' then 'This video belongs here because it shows how easily discovery turns into theater. Forge Academy uses it as a guided companion for founders who want better conversations, better signal, and less self-deception.'
        when 'how-to-get-your-first-customers-startup-school' then 'This is not a hype video about growth. It is a grounded lesson in what early traction actually demands from a founder: manual effort, direct contact with the market, and fewer fantasies about scale too soon.'
        when 'startup-pricing-101-kevin-hale' then 'Pricing is one of the fastest places a founder reveals how clearly they think. This video belongs in Academy because it turns pricing from an emotional guess into something more strategic and more honest.'
        when 'the-real-product-market-fit-michael-seibel' then 'Founders love the phrase product-market fit because it makes momentum feel official. This video earns its place by making the concept harder to misuse and harder to flatter yourself with.'
        when 'business-model-pressure-test' then 'This resource is built for the moment when the business sounds coherent but you suspect some of the logic is still borrowed confidence. Use it to expose the assumptions that would hurt most if they turned out to be wrong.'
        when 'customer-discovery-interview-guide' then 'A founder usually does better discovery once the conversation has structure. This resource is here to keep curiosity honest and stop interviews from drifting into charm, approval-seeking, or vague takeaways.'
        when 'simple-pricing-ladder' then 'This is for founders who know one awkward number cannot carry the whole monetization story. Use it to think through how price shapes commitment, value perception, and the path from first yes to deeper value.'
        when 'founder-decision-memo' then 'Important founder decisions stay messy longer than they should when they live only in emotion, conversation, or half-formed instinct. This resource gives the decision enough structure to become real.'
        else description
    end,
    why_this_matters = case slug
        when 'how-to-talk-to-users-startup-school' then 'Most founders do not need more customer conversations. They need fewer fake ones and better real ones.'
        when 'how-to-get-your-first-customers-startup-school' then 'Early traction is where founder fantasy usually collides with market reality.'
        ...
        when 'the-real-product-market-fit-michael-seibel' then 'Calling product-market fit too early can make a weak business feel stronger than it is.'
        when 'business-model-pressure-test' then 'The market is eventually going to pressure-test the business for you. It is cheaper if you do it first.'
        when 'customer-discovery-interview-guide' then 'Founders get misled less by bad answers than by bad interview structure.'
        when 'simple-pricing-ladder' then 'Pricing is where founder psychology, business design, and buyer behavior all collide.'
        when 'founder-decision-memo' then 'Some of the most expensive founder mistakes begin as decisions nobody ever forced into clear language.'
    ...
    what_to_watch_for = case slug
        ...
        when 'the-real-product-market-fit-michael-seibel' then 'Watch for the difference between momentum that feels exciting and pull that keeps showing up without being begged into existence.'
    ...
    starter_prompt = case slug
        ...
        when 'pick-a-problem-worth-building-on' then 'Start by challenging the instinct to build around any problem that feels interesting. I want you to show me the difference between a problem people notice, a problem they complain about, and a problem that actually deserves a company built around it.'
        ...
        when 'fear-of-selling-is-fear-of-judgment' then 'Start by naming the thing founders usually avoid saying out loud: selling feels hard because judgment feels personal. Then walk me into a better way to carry that moment.'
